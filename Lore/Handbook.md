...
- **2026-09-24:**
  ...
  - The earlier image download had stopped at file names beginning with "M". The missing files were downloaded (`download 1873-1919`; a 429 from Wikimedia's shared-IP rate limit now sends the file to the back of the queue instead of stalling the run). 233 of the 239 notes now have a lead picture. Commons has no picture of the other six: [[Charles S. Ryan]], [[Faik Tonguç]], [[Gustav von Hochwächter]], [[Mehmet Şevki Yazman]], [[İbrahim Sorguç]], [[Şemsi Paşa]] (only the 16th-century Şemsi Ahmed Paşa, a different man).
